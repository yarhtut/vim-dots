...
highlight Normal                    guifg=#E6E1DC guibg=#cc7833
highlight Cursor                    guifg=#FFFFFF ctermfg=0 guibg=#FFFFFF ctermbg=15
highlight CursorLine                guibg=#000000 ctermbg=233 cterm=NONE
highlight Boolean                   ctermfg=209 "ctermbg=NONE cterm=NONE guifg=#ca94ff guibg=NONE gui=NONE
highlight Character                 ctermfg=51
highlight Comment                   guifg=#4e4e4e ctermfg=239
highlight Constant                  guifg=#4596ff ctermfg=73 "not working

highlight Define                    guifg=#ff6458 ctermfg=173
highlight Error                     guifg=#FFC66D ctermfg=221 guibg=#990000 ctermbg=88
highlight Function                  guifg=#50e7c5 ctermfg=7 gui=NONE cterm=NONE
...
highlight Visual                    guibg=#5A647E ctermbg=203 " not working
highlight Variable                  guibg=#5A647E ctermbg=203 " not working

highlight DiffAdd                   guifg=#E6E1DC ctermfg=7 guibg=#519F50 ctermbg=71
highlight DiffDelete                guifg=#E6E1DC ctermfg=7 guibg=#660000 ctermbg=52
highlight Special                   guifg=#bb3333 ctermfg=167

highlight rubyBlockParameter        guifg=#7bcfff ctermfg=81
highlight rubyClass                 guifg=#8eb999 ctermfg=81
highlight rubyConstant              guifg=#72b6ff ctermfg=167
highlight rubyInstanceVariable      guifg=#aa0000 ctermfg=12
highlight rubyInterpolation         guifg=#d990de ctermfg=107
highlight rubyLocalVariableOrMethod guifg=#d990de ctermfg=189
highlight rubyPredefinedConstant    guifg=#4596ff ctermfg=168
highlight rubyPseudoVariable        guifg=#4596ff ctermfg=83
...
highlight rubyClassVariable         guifg=#aa0000
...
highlight xmlTagName                guifg=#E81F6A ctermfg=173
...
highlight SpellCap                  guifg=#ff000F ctermfg=10 guibg=NONE ctermbg=NONE gui=underline cterm=underline
